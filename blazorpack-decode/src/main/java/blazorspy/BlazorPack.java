...
/**
 * BlazorSpy — Burp Suite extension entry point.
 *
...
public class BlazorPack implements BurpExtension {
    ...
    public void initialize(MontoyaApi api) {
        api.extension().setName("BlazorSpy");
        ...
        api.logging().logToOutput("BlazorSpy v" + version + " loaded");
        ...
        api.logging().logToOutput("  2. Click the 'BlazorSpy' tab");
